...
using Confab.Modules.Attendances.Application.Clients.DTO;
...
public class AgendaItemAssignedToAgendaSlotHandlerTest
{
    ...
    public AgendaItemAssignedToAgendaSlotHandlerTest()
    {

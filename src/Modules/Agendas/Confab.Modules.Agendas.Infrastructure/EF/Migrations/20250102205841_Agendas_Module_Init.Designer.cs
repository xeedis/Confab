...
namespace Confab.Modules.Agendas.Infrastructure.EF.Migrations
{
    ...
    [Migration("20250102205841_Agendas_Module_Init")]
            ...
            modelBuilder.Entity("SpeakerSubmission", b =>
                {
                    ...
                    b.Property<Guid>("_speakersId")
                        .HasColumnType("uuid");

                    b.HasKey("SubmissionsId", "_speakersId");

                    b.HasIndex("_speakersId");
